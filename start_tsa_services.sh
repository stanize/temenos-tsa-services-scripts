...
# Usage: ./start_tsa_services.sh <TSA_SERVICE>
# Example: ./start_tsa_services.sh TSA.SERVICE
...
OFS_COMMAND="TSA.SERVICE,START/I/PROCESS,${USER_ID}/${SESSION_ID},${TSM_ID_ESCAPED}"
